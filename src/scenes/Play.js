class Play extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.image('rocket', './assets/frog-sprite1.png');
        this.load.image('spaceship', './assets/bug-sprite.png');
        this.load.image('starfield', './assets/stream.png');
        // load spritesheet
        this.load.spritesheet('explosion', './assets/bugsplat.png', {frameWidth: 64, frameHeight: 32, startFrame: 0, endFrame: 9});
    }
    create() {
        var t = 0;
        // place tile sprite
        ...
        this.timeRight = this.add.text(borderUISize + borderPadding + 400, borderUISize + borderPadding*2 , this.timeLeft, timerConfig);
